...
func NewHandler(pool *pgxpool.Pool, identityService *identity.Service, tokenManager *auth.TokenManager, serverService *servers.Service, messageService *messages.Service) http.Handler {
	router := gin.New()
